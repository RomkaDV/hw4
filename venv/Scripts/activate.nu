...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\IRINA\PycharmProjects\Autotesting web-applications in Python\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\IRINA\PycharmProjects\Autotesting web-applications in Python\venv\Scripts\deactivate.nu'
